...
export default function QuizDetail() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-32 select-none font-sans">
      
      {/* ─── STICKY APP HEADER ───────────────────────────────────────────────── */}
      <nav className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200/90 px-4 py-2.5 flex items-center justify-between shadow-2xs">
      ...
      {/* ─── 4-TAB SEGMENTED BAR ────────────────────────────────────────────── */}
      <div className="bg-white border-b border-slate-200/80 sticky top-[53px] z-30 shadow-2xs">
      ...
      <div className="fixed bottom-0 inset-x-0 bg-white/95 backdrop-blur-md border-t border-slate-200/90 p-3 sm:p-4 z-40 shadow-lg">
        <div className="max-w-5xl mx-auto flex items-center gap-2.5">
          ...
          <button
            ...
            className="px-3.5 py-3 rounded-2xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-black flex items-center justify-center gap-1.5 active:scale-95 transition-all cursor-pointer shrink-0"
          ...
          <button
            ...
            className="px-4 py-3 rounded-2xl bg-amber-50 hover:bg-amber-100 border border-amber-200 text-amber-700 text-xs font-black flex items-center justify-center gap-1.5 active:scale-95 transition-all cursor-pointer shrink-0"
          ...
          <button
            ...
            className="flex-1 py-3 bg-gradient-to-r from-indigo-600 via-purple-600 to-rose-500 hover:from-indigo-700 hover:to-rose-600 text-white rounded-2xl text-xs sm:text-sm font-black uppercase tracking-wider shadow-md shadow-indigo-200 active:scale-98 transition-all flex items-center justify-center gap-2 cursor-pointer"
          >
